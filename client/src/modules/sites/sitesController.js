export class SitesController{
  ...
  constructor(SitesService,
    ...
    function save(site) {
      ...
      if (site.isNew) {
        SitesService.save(site, success, failure);
      } else {
        SitesService.update({id: site.id}, site, success, failure);
      }
    ...
    function _delete(site) {
      ...
      SitesService.delete({id: site.id}, function () {
    ...
    function load() {
      SitesService.query(function (responce) {
        vm.sites = responce;
      });
    }
